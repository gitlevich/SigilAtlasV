...
I can traverse a @slice by specifying @slice#time-direction and expect to see a @slice!ordered sequence of @ImageSigils sorted in that direction to appear in my @frame.
