...
Relief is the physics the rendering engine puts on the @surface. It is objective — arrangement-derived, @POV-independent, the view from nowhere. The @POV sees it as terrain only via @Perspective; Relief alone is just elevation data on the ground.
