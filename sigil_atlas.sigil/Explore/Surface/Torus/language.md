...
How @images occupy the surface depends on the mode. In @timelike mode, @strips tile the entire surface. In @spacelike mode, @neighborhoods form around @attractors and overlap smoothly — the surface is a continuous field, not a tiling.
